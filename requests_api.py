...
print(req.post("https://foodware-backend.herokuapp.com//api/v1", data=json.dumps({"barcode": "1111", "id":"4","quantity":100, "key":"27b7ad855cbc541a83b45b657ac7fdc8b10f19f0c6b028a854322f6e0a8e43e4"}), headers={'content-type': 'application/json'}).text)
